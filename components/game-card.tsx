...
export default function GameCard({
  ...
  return (
    <div className="relative">
      {/* Card principal */}
      <Link href={href} className={`block ${isComingSoon ? 'cursor-default pointer-events-none' : ''}`}>
        <motion.div
          className="group relative overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm transition-all duration-300 cursor-pointer"
          variants={{
